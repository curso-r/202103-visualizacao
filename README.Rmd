...
- [Clique aqui](https://github.com/curso-r/main-visualizacao/raw/master/material_do_curso.zip) para baixar o material do curso **(EM BREVE)**.

- Os pacotes necessários no curso e o código para instalação estão disponíveis [neste link](https://github.com/curso-r/main-visualizacao#pacotes-necess%C3%A1rios).
